          ...
          <div className="mb-2 md:mb-0 items-center lg:ml-[51px]">
            ...
            <div className="brands mt-6">
              ...
              <div className="flex flex-row space-x-5 md:space-x-8 mb-2 w-full md:w-[463px] md:h-[64px] pt-4">
                ...
                /> */}
                 <Image
                  className="w-[58.81px] h-[27.58px] cursor-pointer"
                  alt="brands"
                  src={Nike}
                />

                <Image
                  className="w-[53.87px] h-[36.37px] cursor-pointer"
                  alt="brands"
                  src={Adidas}
                />
               
                <Image
                  className="w-[80px] h-[41.52px] cursor-pointer"
                  alt="brands"
                  src={Puma}
                />
                <Image
                  className="w-[119.7px] h-[39.6px] cursor-pointer"
                  alt="brands"
                  src={Reebook}
                />
              </div>
