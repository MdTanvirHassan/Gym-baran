        ...
        <div className=" px-5 mx-auto">
          <div className="flex flex-wrap -m-4">
            <div className="p-4 md:w-1/2 w-full">
              <div className="h-full bg-white shadow-lg shadow-gray-300 p-8 rounded">
                <svg
                ...
                <p className="leading-relaxed mb-6">
                  ...
                  the gymbaran. My day feels fresher when I regularly
                  participate in this fun sport. Good luck to the coaches.
                </p>
                <a className="inline-flex items-center">
                  ...
                  <span className="flex-grow flex flex-col pl-4">
                    ...
                    <span className="text-gray-500 text-sm">Designer Graphic</span>
                  </span>
                </a>
              </div>
            </div>
